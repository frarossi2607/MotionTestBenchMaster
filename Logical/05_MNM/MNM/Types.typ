...
TYPE
	...
	MNM_AutoStep : 
		...
		MNM_AutoMachineCocPhasingConfig := 900,
		MNM_AutoMachineCocleaPhasing := 901,
		MNM_AutoMachineCocleaPhasingDone := 902,
		MNM_AutoMachineRinPhasingConfig := 920,
		MNM_AutoMachineRinserPhasing := 921,
		MNM_AutoMachineRinserPhasingDone := 922,
